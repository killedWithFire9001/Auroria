      ...
      let collector = msg.channel.createCollector(m => m);
         collector.on('message', m => {
          ...
          dispatcher.resume();
             ...
             if (msg.content.replace(cmd + "play ", "").startsWith(cmd + "play ") || msg.content.replace(cmd + "play ", "").startsWith(cmd + "play")) {
              const embed = new Discord.RichEmbed()
            .setTitle('-=-=-=-= Error -=-=-=-=')
            .setAuthor( bot.user.username, bot.user.avatarURL )
            .setColor(0x00AE86)
            .setDescription(`**Syntax:** play (link/query)`)
            .setFooter('', '')
            .setImage( "" )
            .setThumbnail( "" )
            .setTimestamp( '' )
         ...
         const embed = new Discord.RichEmbed()
            ...
            .setAuthor( bot.user.username, bot.user.avatarURL )
            .setColor(0x00AE86)
            .setDescription(`**Searched:** ${msg.content.replace(cmd + "play ", "")}`)
            .setFooter('', '')
            .setImage( "" )
            .setThumbnail( "" )
            .setTimestamp( '' )
