exports.desc = "View the latest news for CNN!";
exports.syntax = "cnn"
...
exports.run = function(msg) {
  ...
  unirest.get('https://newsapi.org/v1/articles?source=cnn&sortBy=top&apiKey=' + main.auth["news-token"])
